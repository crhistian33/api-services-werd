...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'ID del registro Image a eliminar. Se envía cuando el usuario borra la imagen actual sin subir una nueva.',
        example: 'uuid-del-image-record',
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsUUID)(),
    __metadata("design:type", String)
], UpdateCategoryDto.prototype, "removedImageId", void 0);
