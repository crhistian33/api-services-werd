...
const customer_auth_controller_1 = require("./controller/customer-auth.controller");
    ...
    (0, common_1.Module)({
        imports: [
            ...
            jwt_1.JwtModule.registerAsync({
                ...
                useFactory: (config) => {
                    const adminConfig = config.get('jwt.admin');
                    const jwtOptions = {
        ...
        controllers: [auth_controller_1.AuthController, customer_auth_controller_1.CustomerAuthController],
        providers: [
